...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonCheckbox, IonList, IonItem, IonLabel, IonItemDivider, IonButtons, IonMenuButton } from '@ionic/react';
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle>CheckBox Example</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
        <IonList>
